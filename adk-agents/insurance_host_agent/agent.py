...
class HostAgent:
        ...
        async with httpx.AsyncClient(timeout=30) as client:
            for address in remote_agent_addresses:
                ...
                try:
                    ...
                    print("Added an agent {}".format(card.name))
    ...
    async def create(
        ...
        instance = cls()
        print("Fetching agent cards from the following remote agents: {}".format(remote_agent_addresses))
    ...
    def create_agent(self) -> Agent:
        return Agent(
            ...
            description="This Host agent orchestrates customer support for insurance cross selling.",
            tools=[
                self.send_message,
            ],
        )
    ...
    def root_instruction(self, context: ReadonlyContext) -> str:
        return f"""
        **Role:** You are the Host Agent, you are a professional customer service support agent for an insurance 
        ...
        use the cross_selling_agent. This agent will analyze the customer's history and profile to develop a suitable 
        ...
        Customer Communication: For drafting and sending emails or other communications to the customer, you must use
         the communications_agent. This agent will take the strategy or solution you've formulated and craft a 
...
def get_initialized_host_agent_sync():
    ...
    async def _async_main():
        ...
        subagent_urls = [
            "http://communications-agent:10002",  # Communications agent
            "http://cross-selling-agent:10003",  # X selling agent
        ]
