...
_mock_database = {
    ...
    "term_life_basic": {
        ...
        "base_premium_rate": 0.5,  # per 1000 coverage per month
        "features": [
    ...
    "senior_life_insurance": {
        ...
        "base_premium_rate": 2.5,  # per 1000 coverage per month
        "features": [
    ...
    "family_protection_life": {
        ...
        "base_premium_rate": 0.7,  # per 1000 coverage per month
        "features": [
    ...
    "business_owner_life": {
        ...
        "base_premium_rate": 0.9,  # per 1000 coverage per month
        "features": [
