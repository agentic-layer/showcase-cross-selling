...
_mock_database = {
    ...
    "car_insurance_premium": {
        ...
        "features": [
            ...
            "Rental car coverage with no daily limit",
    ...
    "home_insurance_condo": {
        ...
        "features": [
            "Covers improvements not included in HOA policy",
    ...
    "home_insurance_premium": {
        ...
        "coverage_types": [
            ...
            "Personal property (special limits for valuables)",
            "Liability",
            "Additional living expenses",
            "Equipment breakdown",
        ...
        "features": [
            ...
            "Increased limits for jewelry, art, and collectibles",
    ...
    "personal_liability_insurance_family": {
        ...
        "features": [
            ...
            "Children's liability covered",
            "Damage to rented property",
            "Loss of keys coverage",
            "Pet damage liability (dogs excluded)",
            "Worldwide coverage",
        ],
    ...
    "personal_liability_insurance_premium": {
        ...
        "features": [
            ...
            "Dog liability included",
            "Voluntary work coverage",
            "Damage to borrowed items",
            "Internet liability",
            "Loss of keys (commercial buildings)",
            "No deductible",
            "Worldwide coverage",
        ],
    ...
    "legal_protection_insurance_traffic": {
        ...
        "features": [
            ...
            "Contract disputes for vehicle purchases",
            "Assistance with driver's license matters",
    ...
    "legal_protection_insurance_comprehensive": {
        ...
        "features": [
            ...
            "Unlimited coverage sum",
            "Worldwide coverage",
            "Online dispute resolution",
            "Identity theft legal support",
            "Free preventive legal advice hotline",
        ],
    ...
    "motorcycle_insurance_premium": {
        ...
        "discount_factors": [
            "Garage parking",
            "Experienced rider discount (10+ years)",
        ...
        "features": [
            ...
            "Track day coverage available",
            "Custom parts coverage",
            "Europe-wide breakdown assistance",
    ...
    "electronics_insurance_smartphone": {
        ...
        "features": [
            "Same-day or next-day repair",
            "Replacement device during repair",
            "No police report needed for damage claims",
            "Worldwide coverage",
        ],
    },
    "electronics_insurance_comprehensive": {
        ...
        "features": [
            ...
            "No single-item value limit",
            "Data recovery service included",
            "Home office equipment covered",
    ...
    "valuables_insurance_jewelry": {
        ...
        "coverage_basis": "Agreed value",
        "average_premium_range": {"min": 2, "max": 8},  # per 1000 EUR insured value per year
        "features": [
            "Worldwide all-risk coverage",
            "No deductible",
            "Coverage during transit",
            "Mysterious disappearance covered",
            "Professional valuation service included",
        ],
    ...
    "valuables_insurance_collection": {
        ...
        "average_premium_range": {"min": 1.5, "max": 5},  # per 1000 EUR insured value per year
        "features": [
            "Worldwide all-risk coverage",
            "Exhibition coverage",
            ...
            "Expert appraisal network access",
        ],
    ...
    "rental_deposit_insurance_student": {
        ...
        "features": [
            "Lowest rates for students",
            "Accepted by student housing providers",
            "Digital application in 5 minutes",
    ...
    "rental_deposit_insurance_family": {
        ...
        "features": [
            "Covers up to 30,000 EUR",
            "Includes moving cost insurance",
            "Legal advice for rental disputes",
            "Quick claim processing",
            "Transferable to new rental",
        ],
    ...
    "personal_cyber_insurance_family": {
        ...
        "features": [
            ...
            "Credit monitoring for all adults",
            "Dark web monitoring",
            "VPN service included",
            "Annual security audit for home network",
        ],
