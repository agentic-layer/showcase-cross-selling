...
agent_runtime_install(version='0.28.0')
...
agent_gateway_krakend_install(version='0.6.7', instance=False)
...
# Monitoring
k8s_resource('lgtm', labels=['monitoring'], port_forwards=['11000:3000', '11100:9090', '11101:3200', '11102:4040'])
...
if 'testbench' in profiles:
    testbench_install(version='0.8.2', operator_version='0.8.2')
