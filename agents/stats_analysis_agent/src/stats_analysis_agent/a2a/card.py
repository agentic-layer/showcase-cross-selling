...
cancellation_or_non_renewal_pattern_skill: AgentSkill = AgentSkill(
...
customer_segmentation_skill: AgentSkill = AgentSkill(
...
customer_behavior_analysis_skill: AgentSkill = AgentSkill(
...
product_popularity_skill: AgentSkill = AgentSkill(
...
ltv_analysis_skill: AgentSkill = AgentSkill(
...
product_bundle_analysis_skill: AgentSkill = AgentSkill(
...
geographic_analysis_skill: AgentSkill = AgentSkill(
...
risk_profile_analysis_skill: AgentSkill = AgentSkill(
...
anchor_product_analysis_skill: AgentSkill = AgentSkill(
